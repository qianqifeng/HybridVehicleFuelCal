...
%{
 ...
 % @retval None
%}
function [xi,yi,zi] = EngEquFuelCurPlt(spd,trq,b,varargin)
    if nargin == 3
        dx = 10;
    else
        dx = varargin{1};
    ...
    v = [220:5:270 280:20:350];        % Contour line showing the fuel consumption number
%     v = [120:10:220 220:20:300 300:10:400 400:30:600];
    hf = figure; set(hf,'color',[1 1 1]);
    [c,~] = contour(xi,yi,zi,v);
    xlabel('Engine speed£¨r/min£©');ylabel('Engine torque£¨Nm£©');title('Engine map');
    hold on; clabel(c);
    ...
    hold on;grid;plot(fcMapSpdin,fcMapTrqin,'b-','LineWidth',3);
end
